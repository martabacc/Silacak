  ...
  //   });
	$('#master-page').masterPage({
		...
		additionalInput: 
			...
			{id:'filter_tahun', submittedName:'pub_tahun'},
	...
	$('#master-pegawai').masterPage({
		...
		cols: [
			...
			{ visible:    false },
			/* jur_perguruan_tinggi - 3 */
			{ visible:    false },
			/* peg_program_studi - 4 */
			{ visible:    false },
			/* peg_jenjang_pendidikan - 5 */
			{ visible:    false },
			/* peg_satuan_kerja - 6 */
			{ visible:    false },
			/* peg_ikatan_kerja_pegawai - 7 */
			{ visible:    false },
			/* peg_status_aktivitas_pegawai - 8 */
			{ visible:    false },
			/* peg_jenis_pegawai - 9 */
			{ visible:    false },
			/* peg_jenis_dosen - 10 */
			...
			/* peg_pangkat_pns - 11 */
			{ visible:    false },
			/* peg_jabatan_fungsional - 12 */
			{ visible:    false },
			/* peg_jabatan_struktural - 13 */
			{ visible:    false },
			/* peg_jenis_kelamin - 14 */
			{ visible:    false },
			/* peg_provinsi - 15 */
			{ visible:    false },
			/* peg_kota - 16 */
			...
			/* peg_gelar_depan - 25 */
			{ visible:    false },
			/* peg_gelar_belakang - 26 */
			{ visible:    false },
			/* peg_tempat_lahir - 27 */
			{ visible:    false },
			/* peg_tanggal_lahir - 28 */
			{ visible:    false },
			/* peg_alamat - 29 */
			{ visible:    false },
			/* peg_telepon - 30 */
			...
			/* peg_email - 32 */
			{ visible:    false },
			/* peg_tanggal_berhenti - 33 */
			{ visible:    false },
			/* peg_tanggal_masuk - 34 */
			{ visible:    false },
			/* peg_nomor_sertifikasi - 35 */
			{ visible:    false },
			/* peg_tanggal_keluar_sertifikasi - 36 */
			{ visible:    false },
			/* peg_is_dosen - 37 */
			{ visible:    false },
			/* peg_periode_pelaporan - 38 */
			{ visible:    false },
			/* peg_google_schoolar - 39 */
			{ visible:    false },
			/* peg_penelitian - 40 */
			{ visible:    false },
			/* peg_created_at - 41 */
		...
		selectCallback: function(clicked_data, options){
			...
			if (flag_pegawai == 0)
			{
				$("#peg_name").val(clicked_data[23]);
				$("#filter_pegawai").val(clicked_data[0]);
			}
			else if (flag_pegawai == 1)
			{
				$("#ang_pegawai_"+currentIndex).val(clicked_data[23]);
