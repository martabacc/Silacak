				...
				<div class="portlet-body">
					<div class="masterpage-filter form-inline">
						...
						<div class="filter-part col-md-8">
							<div class="row">
								<label class="col-md-3">Laboratorium</label>
								<div class="col-md-7">
									<?php make_object_combobox($filter_lab, 'labits_id', 'labits_nama', array('id'=>'filter_lab', 'class'=>' select2 form-control input-medium'), TRUE, TRUE, 'master_all'); ?>
								</div>
							</div>
						</div>
						<!-- end added for lab -->
						...
						<div class="filter-part col-md-5">
							<div class="form-group">
								...
								<div class="col-md-7 input-placement" style="padding-left: 30px">
						...
						<hr class="no-margin"/>
						<a href="#" id="btn-download" class="btn green-seagreen margin-top-10">Download Tabel</a>
