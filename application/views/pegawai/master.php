		...
		<div id="master-page">
			<div class="detail-page portlet light bg-inverse form-fit" >
				<div class="portlet-title">
					...
					<div class="actions">
						<button type="button" id="btn-show-impor" class="btn green-seagreen">
							<i class="fa fa-download"></i> Impor Data
						</button>
						...
						<div class="form-body">
							...
							<!-- <div class="form-group">
								...
								<div class="col-md-9 input-placement">
									<input id="peg_name" name="peg_name" type="text" maxlength="255" placeholder="<?php echo $this->lang->line('peg_name_help'); ?>" title="<?php echo $this->lang->line('peg_name_help'); ?>" class="form-control" />
									<span class="help-block"><?php echo $this->lang->line('peg_name_help'); ?></span>
								</div>
							</div> -->
							<div class="form-group">
								<label class="control-label col-md-3"><?php echo $this->lang->line('peg_name'); ?></label>
							...
							<div class="form-group">
								<label class="control-label col-md-3"><?php echo $this->lang->line('peg_email'); ?></label>
								<div class="col-md-9 input-placement" style="padding-left: 0px;">
									<div class="col-md-6">
										<input id="peg_email" name="peg_email" type="text" maxlength="255" placeholder="<?php echo $this->lang->line('peg_email_help'); ?>" title="<?php echo $this->lang->line('peg_email_help'); ?>" class="form-control" />
										<!-- <span class="help-block"><?php echo $this->lang->line('peg_email_help'); ?></span> -->
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">Konfirmasi <?php echo $this->lang->line('peg_email'); ?></label>
								<div class="col-md-9 input-placement" style="padding-left: 0px;">
									<div class="col-md-6">
										<input id="peg_confirm_email" name="peg_confirm_email" type="text" maxlength="255" placeholder="Masukkan email lagi" title="Masukkan email lagi" class="form-control" />
										<!-- <span class="help-block"><?php echo $this->lang->line('peg_email_help'); ?></span> -->
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-9 input-placement">
									<input id="peg_google_schoolar" name="peg_google_schoolar" type="text" maxlength="255" placeholder="<?php echo $this->lang->line('peg_google_schoolar_help'); ?>" title="<?php echo $this->lang->line('peg_google_schoolar_help'); ?>" class="form-control" />
									<span class="help-block"><a href="#" id="link_peg_google_scholar" target="_blank">Pergi ke halaman google scholar</a></span>
								</div>
							</div>
								...
								<div class="col-md-offset-3 col-md-9">
									<div class="detail-control">
										...
										<button id="btn-save" type="button" class="btn green-seagreen mp-save-button">
											<i class="fa fa-floppy-o"></i> <span>Simpan</span>
										</button>
									</div>
								</div>
							</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form id="import-file" class="form-detail form-horizontal">
			...
			<!-- <table width="100%">
				<tr>
					<td width="100%"><input width="100%" type="file" name="file-input" id="file-input" /></td>
				</tr>
				<tr>
					<td align="left">
						<a href="javascript:void(null);" class="btn green" id="btn-import">Import Data</a>
					</td>
				</tr>
				<tr>
					<td>
						Format file harus bertipe csv
					</td>
				</tr>
				<tr>
					<td>
						Urutan data dalam file adalah NRP, NAMA MAHASISWA, GENDER, TEMPAT LAHIR, TANGGAL LAHIR, JENJANG
					</td>
				</tr>
			</table> -->
	    </form>
