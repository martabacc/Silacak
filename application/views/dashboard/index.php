...
<script type="text/javascript">
    ...
    var autosync_pdt = <?php echo $setting_autosyncpdt; ?>;
...
<div class="row">
	<div class="col-md-12">
        ...
        <div class="row" style="padding-left:15px; padding-bottom:15px">
            <label><?php echo $this->lang->line('setting_autosyncpdt'); ?>:</label>
            <label id="auto_pdt" style="font-weight:bolder; font-size:large"><?php echo ($setting_autosyncpdt == 1 ? "ON" : "OFF"); ?></label>
        </div>
        <div class="clearfix"></div>
		<div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-helper"><?php echo $this->lang->line('stats_keterangan_done') . ' / ' . $this->lang->line('stats_keterangan_all'); ?></span>
                        </div>
                    </div>
