...
class Anggota extends CI_Controller {
	...
	public function index(){
		...
		$data['detil_kode_publikasi'] = $this->m_detil_kode_publikasi->get(/*'dkp_deleted = 0', 'dkp_name asc'*/);
		$data['fakultas'] = $this->m_fakultas->get('fak_deleted_at IS NULL', 'fak_nama_indonesia asc');
		$data['jurusan'] = $this->m_jurusan->get('jur_deleted_at IS NULL', 'jur_nama_indonesia asc');
